...
import { getPosts, categories } from "@/api/post.api";
        ...
        {loading ? (
          <div className="space-y-4">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="flex flex-col md:flex-row gap-4 p-4 rounded-lg border border-border bg-card/50 animate-pulse"
              >
                <div className="w-full md:w-32 h-32 bg-muted rounded-lg"></div>
